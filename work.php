...
<html>
	...
	<div id="fh5co-project">
		...
		<div class="project-content">
			...
			<div class="col-forth">
				<div class="project animate-box" style="background-image:url(images/project-4.jpg);">
					<a href="#" class="desc">
						<span>Application</span>
						<h3>Project Name</h3>
					</a>
			...
			<div class="col-forth">
				<div class="project animate-box" style="background-image:url(images/project-5.jpg);">
					<a href="#" class="desc">
						<span>Application</span>
						<h3>Project Name</h3>
					</a>
			...
			<div class="col-forth">
				<div class="project animate-box" style="background-image:url(images/project-6.jpg);">
					<a href="#" class="desc">
						<span>Application</span>
						<h3>Project Name</h3>
					</a>
			...
			<div class="col-forth">
				<div class="project animate-box" style="background-image:url(images/project-7.jpg);">
					<a href="#" class="desc">
						<span>Application</span>
						<h3>Project Name</h3>
					</a>
